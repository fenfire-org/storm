...
public class MultiDB implements MultiDBinf {
    static private void p(String s) { System.out.println("MultiDB:: "+s); }
    ...
    File dir;
    public MultiDB(File dir) throws IOException {
